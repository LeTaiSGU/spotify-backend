...
public class ArtistController {
        ...
        public ApiResponse<PageResponseDTO<ArtistResponseDTO>> getAllArtistsPaginated(
                ...
                PageResponseDTO<ArtistResponseDTO> response = artistService.getAllArtistsPaginated(pageNo, pageSize,
                                sortBy,
                                sortDir);
        ...
        public ApiResponse<PageResponseDTO<ArtistResponseDTO>> getAllArtistsByStatusPaginated(
                ...
                PageResponseDTO<ArtistResponseDTO> response = artistService.getAllArtistsByStatusPaginated(pageNo,
                                pageSize,
        ...
        @PostMapping("/create")
        public ApiResponse<ArtistResponseDTO> createArtist(
                        @RequestPart("artistRequestDTO") ArtistRequestDTO artistRequestDTO,
                        @RequestPart("img") MultipartFile img) {

                ArtistResponseDTO response = artistService.createArtist(artistRequestDTO, img);
                // Tạo ApiResponse từ ArtistResponseDTO
                ApiResponse<ArtistResponseDTO> apiResponse = ApiResponse
                                .<ArtistResponseDTO>builder()
                                .code(1000)
        ...
        @PutMapping("/update")
        public ApiResponse<ArtistResponseDTO> updateArtist(@Valid @RequestPart ArtistUpdateDTO artistUpdateDTO,
                        @RequestPart("img") MultipartFile img) {
                ArtistResponseDTO response = artistService.updateArtist(artistUpdateDTO, img);
                // Tạo ApiResponse từ ArtistResponseDTO
                ApiResponse<ArtistResponseDTO> apiResponse = ApiResponse
                                .<ArtistResponseDTO>builder()
                                .code(1000)
